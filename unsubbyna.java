 ...
 * @author apiiit-rkv
 */
@WebServlet(urlPatterns = {"/unsubbyna"})
public class unsubbyna extends HttpServlet {
        ...
        Connection conn=null;
            try {
             ...
             if(status == 1){
                  ...
                  response.sendRedirect("deleteactbyna.html");     
              }
              else
                ...
                java.util.logging.Logger.getLogger(unsubbyna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }
