<%-- 
    Document   : deccan
    Created on : 06-Dec-2023, 7:10:07 pm
    Author     : sudharshan
--%>
            ...
            <form id="cust_register_form" action="subscribe" onsubmit="return validateForm1()">
               ...
               <span id="addError" class="error"></span>
                <div class="space">
                     ...
                     <input class="form-control" type="text" id="info" name="news" value="deccan_chronicle" readonly>
                                            
                </div>
                <div class="space">
                     <label for="info" class="form-label">DeliveryPersonId :</label>
                     <input class="form-control" type="text" id="info" name="d_id" value="2" readonly>
