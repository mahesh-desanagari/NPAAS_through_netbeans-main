 ...
 * @author apiiit-rkv
 */
@WebServlet(urlPatterns = {"/add_d_person"})
public class add_d_person extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pwd=request.getParameter("d_psw");
        String phno=request.getParameter("d_pno");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String query="insert into delivery_person values('"+name+"','"+id+"','"+email+"','"+pwd+"','"+phno+"');";
...
//            out.println("</html>");
            ...
            Logger.getLogger(add_d_person.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
